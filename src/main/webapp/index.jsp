...
<html>
   ...
   <body class="head">
       ...
       <section id="gallery">
           ...
           <h1 class="atkinson-hyperlegible-mono-content" style="margin-bottom: 30px;
">GALLERY</h1>
            ...
            <div id="loginPopup" class="login-popup-overlay">
              <div class="login-popup-content">
                ...
                <div class="login-options">
                  <a href="${pageContext.request.contextPath}/restaurant-login.jsp" class="login-box">Restaurant</a>
