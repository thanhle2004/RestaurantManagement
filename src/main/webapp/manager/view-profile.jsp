...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/view-profile-style/styles13.css">
...
<div class="container">
    ...
    <div id="modal-overlay" class="hidden">
        <div class="modal-box">
            <form id="editForm" method="post" action="view-profile">
