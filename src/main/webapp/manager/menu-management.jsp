...
<body>
    ...
    <h2>Menu</h2>
    <a href="<%= request.getContextPath() %>/manager/menu-create.jsp" class="add-btn">➕ Add menu</a>
    ...
    <table>
        ...
        <tr>
            <td><%= foodCount %></td>
            <td><img src="<%= food.getItemImgPath() %>" width="100"></td>
            <td><%= food.getItemName() %></td>
            <td><%= food.getItemPrice() %></td>
            <td><%= food.getItemTimeCook() %></td>
            <td>
                <a href="menu-edit?id=<%= food.getItemId() %>" class="action-link"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360ZM360-360v-170l367-367q12-12 27-18t30-6q16 0 30.5 6t26.5 18l56 57q11 12 17 26.5t6 29.5q0 15-5.5 29.5T897-728L530-360H360Zm481-424-56-56 56 56ZM440-440h56l232-232-28-28-29-28-231 231v57Zm260-260-29-28 29 28 28 28-28-28Z"/></svg></a>
                <a href="menu-delete?id=<%= food.getItemId() %>" class="action-link" onclick="return confirm('Delete this food?')"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a>
            </td>
        </tr>
        <%
            }
    ...
    <table>
        ...
        <tr>
            <td><%= drinkCount %></td>
            <td><img src="<%= drink.getItemImgPath() %>" width="100"></td>
            <td><%= drink.getItemName() %></td>
            <td><%= drink.getItemPrice() %></td>
            <td><%= drink.getItemTimeCook() %></td>
            <td>
                <a href="menu-edit?id=<%= drink.getItemId() %>" class="action-link"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360ZM360-360v-170l367-367q12-12 27-18t30-6q16 0 30.5 6t26.5 18l56 57q11 12 17 26.5t6 29.5q0 15-5.5 29.5T897-728L530-360H360Zm481-424-56-56 56 56ZM440-440h56l232-232-28-28-29-28-231 231v57Zm260-260-29-28 29 28 28 28-28-28Z"/></svg></a>
                <a href="menu-delete?id=<%= drink.getItemId() %>" class="action-link" onclick="return confirm('Delete this drink?')"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a>
            </td>
        </tr>
        <%
            }
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a href="menu-edit?id=<%= dessert.getItemId() %>" class="action-link"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h357l-80 80H200v560h560v-278l80-80v358q0 33-23.5 56.5T760-120H200Zm280-360ZM360-360v-170l367-367q12-12 27-18t30-6q16 0 30.5 6t26.5 18l56 57q11 12 17 26.5t6 29.5q0 15-5.5 29.5T897-728L530-360H360Zm481-424-56-56 56 56ZM440-440h56l232-232-28-28-29-28-231 231v57Zm260-260-29-28 29 28 28 28-28-28Z"/></svg></a>
                <a href="menu-delete?id=<%= dessert.getItemId() %>" class="action-link" onclick="return confirm('Delete this drink?')"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a>
            </td>
        </tr>
        <%
            }
