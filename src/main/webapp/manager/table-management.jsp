...
<head>
    ...
    <title>Chilling Restaurant - Table Management</title>
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <h2>Tables</h2>
            <form action="table-change-password" method="post" class="form-container">
                <label><span>Password:</span><input type="text" name="password" placeholder="Enter new password" required/></label>
            ...
            <table>
                <thead>
                    <tr><th>N.0</th><th>Table Number</th><th>Table Status</th><th>Table Password</th><th></th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="table-delete?id=<%= table.getTable_id() %>" onclick="return confirm('Delete this table?')" class="delete-icon"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a></td>
                    </tr>
                    <% } %>
                </tbody>
            </table>
